...
$ambil = $koneksi->query("SELECT * FROM tb_test WHERE id = '$id'");
        ...
        <div class=" card mb-3">
            ...
            <div class="card-body col-md-6">
                ...
                <form method="POST">
                    ...
                    <div class="form-group">
                        <div class="form-label-group">
                            <input type="hidden" class="form-control" name="id" value="<?php echo $pecah->id ?>">
                            <input type="text" class="form-control" name="namatest" value="<?php echo $pecah->nama ?>">
                ...
                if (isset($_POST['edit'])) {
                    ...
                    $edit = $koneksi->query("UPDATE tb_test SET nama= '$namatest' WHERE id='$id'");
